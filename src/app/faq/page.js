  ...
  const faqs = [
    {
      ...
      answer: "Yes, we specialize in bulk and wholesale supplies for camps, school events, paint-along parties, and creative studios. Bulk discounts depend on categories and volume. Bulk discounts start at 50 units. Please reach out to info@dandicraft.com with your quantities to get a custom quote."
    },
    {
      question: "Do the paint-by-numbers come with paint and brushes?",
      answer: "Yes, our standard Acrylic Paint-by-Number and Custom Paint-by-Number include all materials: the printed canvas, matching numbered acrylic paint pots, and brushes. Note: Our Washable Paint-by-Number series is designed for younger kids and does not include paint; it is configured to coordinate with the Crayola 18-color washable paint set (sold separately on our site and anywhere crayola is sold)."
    },
    {
      question: "How can I purchase plaster craft figures?",
      answer: "Plaster pieces require special bulk packaging and cannot be purchased directly through online checkout. To place an order, please email info@dandicraft.com to request our latest plaster craft catalogs and custom quote sheets."
    },
    {
    ...
    },
    {
      ...
      answer: "All sales are final. Because our craft kits are custom-made or involve granular craft preparations, we do not accept returns, refunds, exchanges, or cancellations. It is possible paint can dry out if it comes dry please let us know and we will gladly send you a new paint. If items arrive damaged or incorrect, please email photos to info@dandicraft.com within 48 hours of delivery for a replacement."
    },
    {
